    ...
    <div>
      <div className="flex flex-col items-center justify-center text-center mb-8">
        ...
        <h2 className="text-3xl tracking-tight uppercase font-bold text-slate-100 flex gap-2">
          Account <span className="text-blue-500">Creation</span>
        </h2>
        <p className="mt-3 text-[10px] font-bold uppercase tracking-widest text-slate-500">New User Registration</p>
      </div>
      ...
      <Card className="w-full shadow-2xl shadow-black/50 border-slate-800 bg-slate-900/80 backdrop-blur-sm">
        <CardHeader className="bg-transparent border-b border-slate-800">
          <CardTitle className="text-slate-300">Identity Provisioning</CardTitle>
        </CardHeader>
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-slate-500" htmlFor="username">
                Assigned Identity (Username)
              </label>
              <Input
                id="username"
                type="text"
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-slate-500" htmlFor="phoneNumber">
                Comms Endpoint (Phone)
              </label>
              <Input
                id="phoneNumber"
                type="tel"
            ...
            <Button type="submit" className="w-full mt-6 h-11 text-xs" disabled={loading}>
              {loading ? "Provisioning..." : "Submit Registration"}
            </Button>

            <div className="text-center text-xs text-slate-500 mt-6 pt-4 border-t border-slate-800">
              ALREADY HAVE CLEARANCE?{" "}
              <Link href="/login" className="font-bold uppercase tracking-wider text-blue-500 hover:text-blue-400 transition-colors ml-2">
                Authenticate
              </Link>
            </div>
          </form>
